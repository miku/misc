...
def dump(args):
    ...
    while True:
        ...
        sys.stderr.write('\rdumping %s (%d) at %d rec/sec %s ' % (record['id'],total_recs,(total_recs/time_lapse),message))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--query", "-q", default="title:lucene", help="Solr query, default is 'title:lucene'")
    parser.add_argument("--limit", "-l", default=100, type=int, help="max records, 0 = unlimited, default = 100")
    parser.add_argument("--qsize", "-qs", default=20, type=int, help="number of records per query, default = 20")
    parser.add_argument("--jsize", "-js", default=10000, type=int, help="number of records per file, default = 10000")
    parser.add_argument("--base", "-b", help="file output basename, number and .mrc extension will be appended automatically")
    parser.add_argument("--delay", "-d", type=float, help="delay in seconds between queries")
    parser.add_argument("--paranoid", "-p", action='store_true', help="use jittered delays")
